...
- Canonical subcategory and prefix tables: [manual/ingest_keywords.md](manual/ingest_keywords.md)
...
- Keep taxonomy/subcategory changes aligned with [manual/ingest_keywords.md](manual/ingest_keywords.md), then run audit tools.
