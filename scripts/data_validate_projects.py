...
PURPOSE: Validates project markdown files for correct YAML front matter and structure in the projects directory.

USAGE:
    1. Place project markdown files in the projects directory.
    2. Run this script to check for missing or malformed YAML front matter.
    3. Review the output for any issues to fix.
